...
export const metadata = {
    ...
    description: 'Gain insights into your appointments with detailed analytics, including visit counts and peak hours.',
    openGraph: {
        title: 'Analytics - Calendly',
        description: 'Gain insights into your appointments with detailed analytics, including visit counts and peak hours.',
...
const Analytics: React.FC = () => {
    return (
        <div className="container mx-auto my-10">
            <Link href='/dashboard' className='mb-4 inline-block py-3 px-8 w-full text-center rounded bg-success/90 hover:bg-success text-light'>Go to Dashboard</Link>
