...
const AnalyticsSection: React.FC = () => {
    const { visitChartData, peakHoursChartData, loading, visitData, peakHoursData } = useAnalytics();

    if (loading) return <LoadingSpinner />;

    return (
        <>
            <h1 className="text-3xl font-bold mb-7 text-center text-dark rounded bg-light py-2">Analytics Dashboard</h1>
            <div className="mb-10">
