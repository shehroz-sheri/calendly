                ...
                <form onSubmit={handleSubmit}>
                    <div className="w-[95%] bg-white sm:w-[645px] mt-4 mx-auto border-[1.5px] rounded-lg">
                        <div className="pt-[32px] px-[12px] sm:px-[24px] border-b-[1.5px]">
                            <div className="flex flex-wrap justify-between min-h-[162.4px]">
                                <div className="flex flex-col justify-evenly">
                                    <h3 className="font-bold text-[18.44px] leading-7">Set your availability</h3>
                        ...
                        <div className="pt-[32px] px-[12px] sm:px-[24px]">
                            <div className="h-[76px] flex flex-col justify-around">
                                <p className="font-bold text-[14.88px] leading-[22px]">Available hours</p>
                        ...
                        <div className="mt-3 px-[12px] sm:px-[24px] pb-6">
                            ...
                            <p className={`flex justify-center ${loginStatus ? 'mt-14' : 'mt-5'}`}>
                                {
                                    loginStatus && <>
                                        <TbSpeakerphone className="transform rotate-[-18deg] sm:me-2 max-sm:text-[22px]" />
                                        <span className="text-[14.75px] text-center">Don’t worry! You’ll be able to further customize your availability later on.</span>
                                    </>
                                }
                            </p>
                        </div>
                    ...
                    <div className="w-[95%] sm:w-[645px] mt-4 mx-auto">
                        <div className="flex justify-between items-center">
                            ...
                            <div>
                                {
                                    loginStatus && <Link href={'/dashboard'} className="text-[12.91px] mr-[17px] hover:text-primary">Set up later</Link>
                                }
                                <button className={`bg-primary hover:bg-primary/90 w-[92px] h-11 text-white rounded-[40px] text-[12.91px] leading-[22px] font-bold ${loading ? 'cursor-not-allowed opacity-50' : ''}`} type="submit">{loading ? 'Loading...' : 'Continue'}</button>
                            </div>
                        </div>
                    </div>
                </form>
